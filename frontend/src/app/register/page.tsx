        ...
        >
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
              ...
              {password && (
                <div className="mt-2 space-y-1">
                  <div className="flex items-center gap-2 text-xs">
                    <CheckCircle className={`h-4 w-4 ${hasMinLength ? 'text-green-500' : 'text-gray-300 dark:text-gray-600'}`} />
                    <span className={hasMinLength ? 'text-green-600 dark:text-green-400' : 'text-gray-500 dark:text-gray-500'}>At least 8 characters</span>
                  </div>
                  <div className="flex items-center gap-2 text-xs">
                    <CheckCircle className={`h-4 w-4 ${hasUpperCase ? 'text-green-500' : 'text-gray-300 dark:text-gray-600'}`} />
                    <span className={hasUpperCase ? 'text-green-600 dark:text-green-400' : 'text-gray-500 dark:text-gray-500'}>One uppercase letter</span>
                  </div>
                  <div className="flex items-center gap-2 text-xs">
                    <CheckCircle className={`h-4 w-4 ${hasNumber ? 'text-green-500' : 'text-gray-300 dark:text-gray-600'}`} />
                    <span className={hasNumber ? 'text-green-600 dark:text-green-400' : 'text-gray-500 dark:text-gray-500'}>One number</span>
                  </div>
                </div>
              )}
            </div>
            ...
            <div className="flex items-start gap-2">
              <input type="checkbox" id="terms" name="terms" className="w-4 h-4 mt-1 rounded border-gray-300 dark:border-gray-600 text-[#FF6B35] focus:ring-[#FF6B35] bg-white dark:bg-gray-800" required />

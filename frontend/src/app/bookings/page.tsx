        ...
        <div className="min-h-[70vh] flex items-center justify-center">
          <Card className="max-w-md w-full border-0 shadow-xl rounded-2xl dark:bg-gray-900 dark:shadow-gray-900/20">
            <CardContent className="p-8 text-center">
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-6">Please sign in to view your bookings</p>
              <Link href="/login">
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 transition-colors duration-300">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        {isLoading ? (
          ...
          <Card className="border-0 shadow-lg rounded-2xl dark:bg-gray-900 dark:shadow-gray-900/20">
            <CardContent className="p-12 text-center">
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-6">Start exploring amazing trips and create unforgettable memories!</p>
              <Link href="/trips">
                <Button className="bg-gradient-to-r from-[#FF6B35] to-[#E55A2B] hover:shadow-lg hover:shadow-[#FF6B35]/25 text-white">
                  Explore Trips
                </Button>
              </Link>
            </CardContent>
          ...
          <div className="space-y-6">
            {data.data.map((booking: any, index: number) => (
              ...
              >
                <Card className="border-0 shadow-lg rounded-2xl hover:shadow-xl transition-shadow overflow-hidden dark:bg-gray-900 dark:shadow-gray-900/10">
                  <CardContent className="p-0">
                    <div className="flex flex-col md:flex-row">
                      {/* Trip Image */}
                      <div className="w-full md:w-56 h-48 md:h-auto bg-gray-200 dark:bg-gray-800 flex-shrink-0">
                      ...
                      <div className="flex-1 p-6">
                        <div className="flex flex-col md:flex-row md:items-start justify-between gap-4 mb-4">
                          <div>
                            <h3 className="text-xl font-bold text-gray-900 dark:text-white">{booking.trip?.title}</h3>
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                          <div className="bg-gray-50 dark:bg-gray-800 rounded-xl p-3">
                            ...
                            <p className="font-semibold dark:text-gray-200">{booking.numberOfGuests}</p>
                          </div>
                          <div className="bg-gray-50 dark:bg-gray-800 rounded-xl p-3">
                            <div className="flex items-center gap-2 text-gray-500 dark:text-gray-400 text-sm mb-1">
                          ...
                          <div className="bg-gray-50 dark:bg-gray-800 rounded-xl p-3">
                            ...
                            <p className="font-semibold capitalize dark:text-gray-200">{booking.paymentStatus}</p>
                          </div>
                          <div className="bg-gray-50 dark:bg-gray-800 rounded-xl p-3">
                            <div className="flex items-center gap-2 text-gray-500 dark:text-gray-400 text-sm mb-1">
                            ...
                            <p className="font-semibold text-xs dark:text-gray-200">#{booking._id.slice(-8)}</p>
                          </div>
                        </div>

                        <div className="flex flex-wrap gap-3">
                          <Link href={`/bookings/${booking._id}`}>
                            <Button variant="outline" size="sm" className="rounded-xl hover:bg-[#FF6B35]/5 hover:border-[#FF6B35] hover:text-[#FF6B35] dark:border-gray-700 dark:text-gray-300 dark:hover:bg-gray-800 dark:hover:text-white">
                              <Eye className="w-4 h-4 mr-2" />
                              View Details
                            </Button>
                          </Link>
                          {booking.status === 'confirmed' && (
                            <Button variant="outline" size="sm" className="rounded-xl text-red-600 border-red-200 hover:bg-red-50 dark:text-red-400 dark:border-red-900/50 dark:hover:bg-red-900/20">

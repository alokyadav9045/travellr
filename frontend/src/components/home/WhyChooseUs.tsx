        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            <motion.p
              ...
              viewport={{ once: true }}
              className="text-[#F15A24] font-medium mb-4"
            >
              Why Travellr?
            </motion.p>
            <motion.h2
            ...
            >
              ...
              <span className="text-[#F15A24]">explore with joy</span>
            </motion.h2>
            <motion.p
              initial={{ opacity: 0, y: 10 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            >
              <Link href="/about">
                <Button className="gap-2" size="lg" suppressHydrationWarning>
                  Learn More About Us
          ...
          <div className="grid sm:grid-cols-2 gap-6">
            {features.map((feature, index) => (
              ...
              >
                <div className="w-12 h-12 bg-[#F15A24]/10 rounded-xl flex items-center justify-center mb-4">
                  <feature.icon className="h-6 w-6 text-[#F15A24]" />
                </div>
